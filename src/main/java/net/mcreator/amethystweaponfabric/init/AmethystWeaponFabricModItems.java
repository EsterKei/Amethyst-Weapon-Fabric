...
import net.mcreator.amethystweaponfabric.AmethystWeaponFabricMod;

import java.util.function.Function;

public class AmethystWeaponFabricModItems {
	...
	private static <I extends Item> I register(String name, Function<Item.Properties, ? extends I> supplier) {
		return (I) Items.registerItem(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(AmethystWeaponFabricMod.MODID, name)), (Function<Item.Properties, Item>) supplier);
	}
}